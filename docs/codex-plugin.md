...
8. When the previous and fresh reports have unique stable `(severity, title)` issue keys, compare those keys and report resolved, remaining, deferred, and newly introduced findings without using generated report prose or terminal output.
