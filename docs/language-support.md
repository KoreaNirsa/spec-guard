...
- The current fixture source contains 110 English cases and 110 Korean cases. The coverage matrix records 22 selected fixture results as missing from the v0.4.1 artifact until the benchmark is refreshed.
...
- The checked-in fixture source is ahead of the recorded v0.4.1 benchmark artifact by 22 selected cases, including #213 Korean phrasing variants and #242 weak-only domain ready/reference guards. Updated 110-case English or Korean pass/fail claims must wait for a benchmark refresh.
